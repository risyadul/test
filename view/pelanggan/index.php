        ...
        <table class="table table-stripped border">
            ...
            <?php foreach($result as $data) : ?>
                <tr>
					...
					<td><?= $data['password'] ?></td>
                    <td>
                        <a href="edit.php?id=<?= $data['id_pelanggan'] ?>" class="btn btn-warning">Edit</a>
                        <a href="../../controller/pelanggan/delete.php?id=<?= $data['id_pelanggan'] ?>" class="btn btn-danger">Delete</a>
                    </td>
                </tr>
            <?php endforeach ?>
        </table>
