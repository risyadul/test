...
<body>
	...
	<div class="container" style="padding-top: 30px;">
		<h1 class="text-center">Edit Form Kategori Produk</h1>
		<hr>
		<br>
        <!-- start form insert -->
        <form action="../../controller/kategori_produk/update.php" method="post">
            <div class="form-group row">
                ...
                <input type="hidden" name="id_kategori" value="<?= $arr['id_kategori'] ?>">
                <input class="form-control col-sm-10" type="text" class="form-control" value="<?= $arr['nama_kategori'] ?>" name="nama_kategori">
            </div>
