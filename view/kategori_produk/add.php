	...
	<div class="container" style="padding-top: 30px;">
        ...
        <form action="../../controller/kategori_produk/insert.php" method="post">
            <div class="form-group row">
                <label for="merk" class="col-sm-2">Nama Ketegori Produk</label>
                <input class="form-control col-sm-10" type="text" class="form-control" name="nama_kategori" placeholder="Masukan Nama Merk Produk">
            </div>
