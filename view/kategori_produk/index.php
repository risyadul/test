...
<body>
	...
	<div class="container" style="padding-top: 30px;">
		<h1 class="text-center">Daftar Kategori Produk</h1>
		<hr>
		<br>
        ...
        <table class="table table-stripped border">
            ...
            <?php foreach($result as $data) : ?>
                <tr>
                    ...
                    <td>
                        <a href="edit.php?id=<?= $data['id_kategori'] ?>" class="btn btn-warning">Edit</a>
                        <a href="../../controller/kategori_produk/delete.php?id=<?= $data['id_kategori'] ?>" class="btn btn-danger">Delete</a>
                    </td>
                </tr>
            <?php endforeach ?>
        </table>
